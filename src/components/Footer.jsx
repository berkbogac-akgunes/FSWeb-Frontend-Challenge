...
export default function Footer() {
    ...
    return(
        ...
        <div>
            <h2 className = "ml-64 w-work-together pt-16 text-6xl mb-8 text-gray-800 dark:text-[#AEBCCF] font-semibold">{translation.footerHeading}</h2>
        </div>
        <div className = "flex justify-between mt-24 mb-32">
            ...
            <div className = "">
                <a className = "text-2xl dark:border-indigo-300 mr-5 font-medium text-grey-800 py-1 px-3" href="">{translation.personalBlog}</a>
